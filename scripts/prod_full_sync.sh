...
# Usage:
#   ./scripts/prod_full_sync.sh [--dry-run] [--uploads-only] [--db-only] [--no-replace] [--keep-archives]
...
log "Summary: DB=$DO_DB uploads=$DO_UPLOADS replace=$DO_REPLACE dry_run=$DRY_RUN"
log "Done."
