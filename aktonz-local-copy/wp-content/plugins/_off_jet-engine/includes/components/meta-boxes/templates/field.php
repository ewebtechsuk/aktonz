<div>
	...
	<cx-vui-switcher
		label="<?php _e( 'Restrict MIME Types', 'jet-engine' ); ?>"
		description="<?php _e( 'Toggle this option to set a list of MIME types allowed in this field', 'jet-engine' ); ?>"
		:wrapper-css="[ 'equalwidth' ]"
	...
	<cx-vui-f-select
		label="<?php _e( 'Allowed MIME Types', 'jet-engine' ); ?>"
		name="allowed_mime_types"
		description="<?php _e( 'Leave empty to allow all MIME types.', 'jet-engine' ); ?>"
		:wrapper-css="[ 'equalwidth' ]"
