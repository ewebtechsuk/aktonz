 ...
 * 2. Add unique prefix for the class name, e.g. - Twentyseventeen_Jet_WC_Product_Table_CX_Loader
 ...
 *     new Jet_WC_Product_Table_CX_Loader(
 *         array(
...
if ( ! class_exists( 'Jet_WC_Product_Table_CX_Loader' ) ) {

	/**
	 * Define Jet_WC_Product_Table_CX_Loader class
	 */
	class Jet_WC_Product_Table_CX_Loader {
